...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   */
      ...
      [_QWERTY] = LAYOUT(
        ...
        CW_TOGG,            KC_A,    KC_S,    KC_D,    KC_F,    KC_G,  ALGR(KC_7), KC_MUTE,RGB_TOG,ALGR(KC_0),KC_H,   KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT,
        LM(_SHIFT,MOD_LSFT),KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,  KC_RBRC,KC_BSPC,      KC_DEL, KC_NUHS, KC_N,   KC_M,    KC_COMM, KC_DOT,  KC_SLSH, MT(MOD_RSFT, KC_EQL),
   ...
   */
      ...
      [_SHIFT] = LAYOUT(
        ...
        _______, _______, _______, _______, _______, _______, KC_8, _______, _______,       KC_9, _______, _______, _______, _______, _______, _______,
        _______, _______, _______, _______, _______, _______, _______,  KC_DEL, _______, _______, _______, _______, _______, _______, _______, _______,
   ...
   */
      ...
      [_RAISE] = LAYOUT(
        ...
        KC_CAPS, KC_PGDN, KC_PGUP, KC_HOME, KC_END,   _______, KC_NUBS, _______, _______, S(KC_NUBS),_______, KC_LEFT, KC_DOWN, KC_RIGHT,_______, _______,
   ...
   */
      ...
      [_LOWER] = LAYOUT(
        ...
        KC_CAPS, KC_P4,   KC_P4,  KC_P5,  KC_P6,  KC_PPLS, ALGR(KC_8),_______,_______,ALGR(KC_9), KC_PAST, KC_P4,    KC_P5, KC_P6,   KC_PPLS, KC_F13, 
        _______, KC_UNDO, KC_P1,  KC_P2,  KC_P3,  KC_COMM, KC_F15, _______,  _______, KC_F16,     KC_NUM,  KC_P1,    KC_P2, KC_P3,   KC_DOT,  KC_F14, 
