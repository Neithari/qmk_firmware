...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   */
      ...
      [_QWERTY] = LAYOUT(
        ...
        LM(_SHIFT,MOD_LSFT),KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,  ALGR(KC_7),KC_BSPC,KC_DEL, ALGR(KC_0), KC_N,   KC_M,    KC_COMM, KC_DOT,  KC_SLSH, MT(MOD_RSFT, KC_EQL),
   ...
   */
      ...
      [_SHIFT] = LAYOUT(
        ...
        _______, _______, _______, _______, _______, _______,    KC_8,  KC_DEL, _______,    KC_9, _______, _______, _______, _______, _______, _______,
   ...
   */
      ...
      [_RAISE] = LAYOUT(
        ...
        _______, _______, _______, _______, _______,  _______, KC_NUBS, _______, _______, S(KC_NUBS),_______,  KC_F10,  KC_F11,  KC_F5,  _______, _______,
   ...
   */
      ...
      [_LOWER] = LAYOUT(
        ...
        _______, KC_UNDO, KC_P1,  KC_P2,  KC_P3,  KC_COMM, ALGR(KC_8),_______,_______,ALGR(KC_9), KC_NUM,  KC_P1,    KC_P2, KC_P3,   KC_DOT,  KC_F14, 
