 ...
 */
	...
	[_RAISE] = LAYOUT(
      KC_GRV,  _______, _______, _______, _______,  _______,                                     _______, _______, _______, _______, _______, _______,
      _______, _______, _______, _______, _______,  _______, KC_LT,                     LKC_GT,  _______, _______, KC_UP,   _______, _______, _______,
 ...
 * |   -  |   /  |   7  |   8  |   9  |   -  |   [  |                  |   ]  |   /  |   7  |   8  |   9  |   -  |  F12  |
 * |------+------+------+------+------+------|______|                  |______|------+------+------+------+------+-------|
 * | Caps |   *  |   4  |   5  |   6  |   +  |  F14 |                  | F15  |   *  |   4  |   5  |   6  |   +  |  F17  |
 * |------+------+------+------+------+------|______|/-----\    /-----\|______|------+------+------+------+------+-------|
 * |   -  | F13  |   1  |   2  |   3  |   ,  |   -  (   -   )  (   -   )   -  | Num  |   1  |   2  |   3  |   ,  |  F18  |
 * |------+------+------+------+------+------|______|\-----/|  |\-----/|______|------+------+------+------+------|-------|
 * |   -  |   -  |   0  |   .  |   -  |      -      |   -  |   |   -   |     -       |   -  |   0  |   .  | Enter|   =   |
 * `--------------------------------------------------------'  '---------------------------------------------------------´
 */
	...
	[_LOWER] = LAYOUT(
      ...
      _______, KC_F13,  KC_P1,  KC_P2,  KC_P3,  KC_COMM, _______, _______,  _______,_______,    KC_NUM,  KC_P1,    KC_P2, KC_P3,   KC_COMM, KC_F18, 
